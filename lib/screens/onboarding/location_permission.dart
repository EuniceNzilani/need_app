    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              const SizedBox(height: 80), // Raised content higher
              Container(
                width: 100,
                height: 100,
                decoration: BoxDecoration(
                  color: const Color(
                    0xFFE6F7F4,
                  ), // Using the consistent background color
                ...
                child: Center(
                  child: SvgPicture.string(
                    ...
                    colorFilter: const ColorFilter.mode(
                      Color(0xFF14A388), // Using the teal color
                      BlendMode.srcIn,
                    ),
                  ),
                ),
