...
class Import1 extends StatefulWidget {
  const Import1({super.key});

  @override
  State<Import1> createState() => _Import1State();
}

class _Import1State extends State<Import1> {
  ...
  final Map<String, Widget> _productBrandPopups = {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.settings, color: Colors.black, size: 22),
            onPressed: () {
              Navigator.pushReplacement(
                context,
...
class TrackRequestScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const Scaffold(body: Center(child: Text('Track Request')));
}
